 ...
 */
class Version20180527131003 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE assignment (id INT AUTO_INCREMENT NOT NULL, assigned_to_id INT NOT NULL, task_id INT NOT NULL, validated_by_id INT DEFAULT NULL, assigned_at DATETIME NOT NULL, done_at DATETIME DEFAULT NULL, validated_at DATETIME DEFAULT NULL, INDEX IDX_30C544BAF4BD7827 (assigned_to_id), INDEX IDX_30C544BA8DB60186 (task_id), INDEX IDX_30C544BAC69DE5E5 (validated_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE assignment ADD CONSTRAINT FK_30C544BAF4BD7827 FOREIGN KEY (assigned_to_id) REFERENCES user (id)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE assignment DROP FOREIGN KEY FK_30C544BAF4BD7827');
